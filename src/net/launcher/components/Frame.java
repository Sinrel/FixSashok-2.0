...
public class Frame
{
	...
	public void start( Stage stage ) {
	    ...
	    stage.getIcons().add( new Image( Starter.class.getResourceAsStream("/net/launcher/theme/favicon.png") ) );
	    
	    stage.setResizable(false);
	    stage.centerOnScreen();
	    
	   // loginScene = new Scene( (Parent) new FXMLLoader().load( Starter.class.getResourceAsStream("/net/launcher/theme/loginForm.fxml") ) );
	   // loginScene.getStylesheets().add(Starter.class.getResource("/net/launcher/theme/style.css").toString());
	    //loginScene.getStylesheets().add(Starter.class.getResource("/net/launcher/theme/loginForm.css").toString());
